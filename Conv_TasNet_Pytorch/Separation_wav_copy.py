...
def main():
    ...
    parser.add_argument(
        '-mix_scp', type=str, default='./test/1-mixed.wav', help='Path to mix scp file.')
    parser.add_argument(
        '-yaml', type=str, default='./options/train/train.yaml', help='Path to yaml file.')
    parser.add_argument(
        '-model', type=str, default='./chkpt/best.pt', help="Path to model file.")
    parser.add_argument(
